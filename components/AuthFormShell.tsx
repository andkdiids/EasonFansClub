...
<main className={`auth-page${pageClassName ? ` ${pageClassName}` : ''}`}>
      <HeroBackground
        visual={heroVisual}
        fallbackImageUrl={backgroundUrl}
      ...
      <div className="auth-page-layout">
        <section className="auth-brand-copy" aria-label="网站介绍"><h2>私家E院</h2>
...
<em>
  NOW IS THE ONLY REALITY.
        ...
        <section className="auth-form-panel">
          <div className="auth-form-heading"><h1>{title}</h1><span>{subtitle}</span></div>
