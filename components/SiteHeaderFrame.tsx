...
export function SiteHeaderFrame({ children }: Readonly<{ children: ReactNode }>) {
  ...
  return (
    <header
      ...
      className={`sticky top-0 z-[100] overflow-visible border-b backdrop-blur-[18px] transition-[background-color,color,border-color,box-shadow] duration-500 ease-out ${musicTheme ? 'border-sky-200/[0.12] bg-[rgba(4,18,34,.78)] shadow-[0_12px_35px_rgba(1,8,18,.22)]' : 'border-sky-100/80 bg-white/88'}`}
    >
