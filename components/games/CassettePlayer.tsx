...
export function CassettePlayer({
  ...
  return (
    <section
      className={`cassette-stage ${playing ? 'is-playing' : ''}`}
      ...
      <div className="cassette-player">
        ...
        <div className="cassette-window">
          ...
          <div className="cassette-label">
            ...
            >
              {loading ? (
                <i className="cassette-loader" />
              ) : playing ? (
                <i className="cassette-pause" />
              ) : (
                <i className="cassette-play-icon" />
              )}
            </button>
          </div>
        ...
        <div className="cassette-controls">
          ...
          <b>
            {remainingPlayCount} PLAY
            {remainingPlayCount === 1 ? '' : 'S'}
          </b>
        </div>
      </div>
    </section>
