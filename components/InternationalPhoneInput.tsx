    ...
    <div className={`${containerClassName || 'mt-1'} flex min-w-0 items-stretch gap-2`}>
      <div ref={rootRef} className={`relative w-[72px] shrink-0 ${countryContainerClassName}`}>
        <input
          ...
          className={`box-border h-11 w-full min-w-0 rounded-lg border border-sky-100 bg-white px-2.5 py-0 pr-6 text-left text-sm outline-none focus:ring-4 focus:ring-brand-500/20 ${countryInputClassName}`}
          aria-label="国家或地区区号"
        />
