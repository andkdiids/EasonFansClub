...
type SongHistory = {
  ...
  concerts: Array<{ concertId: string; date: string; city: string; venue: string | null; tourName: string }>
}
...
export function PersonalSongHistory({ songId }: Readonly<{ songId: string }>) {
  ...
  return <section className="mt-8 border border-sky-300/15 bg-sky-300/[0.055] p-6 sm:p-8" aria-labelledby="personal-song-history-title">
    <p className="text-xs font-black tracking-[0.2em] text-sky-300/65">MY LIVE HISTORY</p><h2 id="personal-song-history-title" className="mt-2 text-3xl font-black text-white">我的现场记录</h2>
