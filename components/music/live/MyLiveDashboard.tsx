...
export function MyLiveDashboard({ data, batchTourId }: Readonly<{ data: DashboardData; batchTourId?: string }>) {
  ...
  return <div className="my-live-dashboard">
    ...
    <header className="my-live-heading py-10 sm:py-14"><h1 className="mt-4 text-5xl font-black text-white sm:text-7xl">我的现场</h1><p className="mt-4 text-sm font-bold text-slate-300/70">记录与你在现场相遇的每一次</p></header>
