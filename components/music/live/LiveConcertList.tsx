...
type Concert = { id: string; title?: string | null; concertDate: string; city: string; venue?: string | null; sessionNumber?: string | null; songCount: number; hasHighlights: boolean; tourName?: string }
