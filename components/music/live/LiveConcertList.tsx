...
type Concert = { id: string; title?: string | null; concertDate: string; city: string; venue?: string | null; sessionNumber?: string | null; stageType?: string | null; songCount: number; hasHighlights: boolean; tourName?: string }

export function LiveConcertList({ concerts, hideFilters = false }: { concerts: Concert[]; hideFilters?: boolean }) {
