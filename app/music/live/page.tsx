...
export default async function MusicLivePage() {
  ...
  return <MusicArchiveShell backgroundVisual={config.heroVisuals.music}>
    ...
    <header className="py-12 sm:py-16"><p className="text-xs font-black tracking-[0.24em] text-sky-300/70">EASON LIVE ARCHIVE</p><h1 className="mt-4 text-5xl font-black tracking-tight text-white sm:text-7xl">Eason现场</h1><p className="mt-5 max-w-3xl text-sm font-bold leading-7 text-slate-300/70 sm:text-base">收录陈奕迅巡演、演唱会场次、现场歌单与特别时刻</p></header>
