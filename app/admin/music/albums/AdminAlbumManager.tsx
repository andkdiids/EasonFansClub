...
type Album = { id: string; name: string; artist: string; releaseYear: number; language: string; coverUrl?: string | null; status: 'DRAFT' | 'PUBLISHED'; displayOrder: number; songs: unknown[] }
...
const initialForm = { albumName: '', artist: '陈奕迅', releaseDate: '', releaseYear: '', language: '粤语', company: '', description: '', story: '', displayOrder: '0' }
