...
export default async function AdminMusicPage() {
  ...
  const modules = [
    ...
    ['/admin/music/categories', '演唱会分类', '配置前台演唱会分类导航（大型/小型/嘉宾），可新增、改名、排序与启停。'],
    ['/admin/music/reviews', '专辑鉴赏管理', '发布专辑幕后故事、制作资料、歌曲解析和多图深度档案。'],
  ] as const
  return <><main className="admin-mobile-page mx-auto max-w-6xl space-y-7 px-4 py-7 sm:px-5 sm:py-9">
