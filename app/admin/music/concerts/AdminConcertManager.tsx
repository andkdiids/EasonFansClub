...
type Concert = { id: string; concertDate: string; city: string; venue?: string | null; sessionNumber?: string | null; status: 'DRAFT' | 'PUBLISHED'; tour: Tour; setlistCount: number; highlightCount: number; attendanceCount: number }
