...
type SyncLog = { id: string; provider: string; target: string; startedAt: string; status: string; foundCount: number; createdCount: number; updatedCount: number; mediaCount: number; durationMs: number | null; errorCode: string | null; errorMessage: string | null }
