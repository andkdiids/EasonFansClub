...
import { BirthdayHistoryBackfill } from './BirthdayHistoryBackfill'
...
export default async function AdminBadgesPage() {
  ...
  const initialBadges: AdminBadge[] = badges.map((badge) => ({
    ...
    rule: badge.BadgeRule ? {
      ...
      sustainedQualification: badge.BadgeRule.sustainedQualification,
      inactiveAfterDays: badge.BadgeRule.inactiveAfterDays,
      revokeAfterDays: badge.BadgeRule.revokeAfterDays,
    } : null,
    ...
    ownerCount: ownershipStats.get(badge.id)?.ownerCount ?? badge._count.UserBadge,
