...
export default function PublicUserError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <main className="mx-auto max-w-4xl px-5 py-10">
      <section className="rounded-[28px] border border-sky-100 bg-white/85 p-8 text-center shadow-sm">
        ...
        <p className="mt-3 text-sm font-bold text-slate-500">帖子、成就、收藏等模块会按需加载，稍后重试即可。</p>
