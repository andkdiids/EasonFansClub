  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-[1500px] px-4 py-6 sm:px-5">
        <section className="grid gap-5 lg:grid-cols-[minmax(260px,0.85fr)_minmax(360px,1.15fr)] xl:grid-cols-[minmax(260px,0.85fr)_minmax(360px,1.15fr)_minmax(380px,1.35fr)]">
          <aside className="rounded-[28px] border border-sky-100 bg-white/85 p-5 shadow-sm">
            <p className="text-sm font-black uppercase tracking-[0.2em] text-brand-700">Daily Clinic</p>
            <h1 className="mt-2 text-3xl font-black text-brand-950">每日挂号</h1>
            <p className="mt-3 text-sm font-bold leading-7 text-slate-600">{getDailyQuote(today)}</p>
          ...
          <section className="rounded-[28px] border border-sky-100 bg-white/85 p-5 shadow-sm">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <p className="text-sm font-black uppercase text-brand-700">{todayCheckIn ? 'Today Mood' : 'Check-in'}</p>
                <h2 className="mt-2 text-3xl font-black text-brand-950">{todayCheckIn ? '今日心情' : '今日挂号'}</h2>
              </div>
            </div>
            <div className="mt-5">
              <CheckInButton
