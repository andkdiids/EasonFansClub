  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-3xl px-5 py-8">
        ...
        <p className="mt-3 mb-6 text-sm font-bold leading-7 text-slate-600">三个问题必须各不相同，答案会规范化后使用与密码同等级的哈希保存。</p>
        {count === 3 ? <p className="rounded-2xl bg-emerald-50 px-5 py-4 font-black text-emerald-700">已设置，不可修改。</p> : <SecurityQuestionsForm />}
      </main>
    </>
  )
}
