  ...
  const [reviews, stats] = await Promise.all([
    prisma.ratingReview.findMany({
      ...
      select: {
        ...
        createdAt: true,
        deletedAt: true,
        User: { select: { id: true, uid: true, nickname: true, username: true, usernameModerationStatus: true, nicknameModerationStatus: true, Profile: { select: { displayName: true, displayNameModerationStatus: true } } } },
