export const heroVisualKeys = ['login', 'register', 'home', 'activities', 'birthday', 'music'] as const
...
export const defaultHeroVisuals: Record<HeroVisualKey, SiteHeroVisualConfig> = {
  ...
  register: { key: 'register', title: '注册页 Hero', imageUrl: '', desktopPositionX: 50, desktopPositionY: 50, mobilePositionX: 50, mobilePositionY: 50, enabled: true, focusPoint: null, updatedAt: '' },
