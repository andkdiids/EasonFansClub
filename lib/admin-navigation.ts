...
export const adminNavigationGroups: readonly AdminNavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/user-operations', title: '用户操作记录', desc: '查看今日重要操作、高风险用户，以及单个用户的统一审计时间线。' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/stickers', title: '表情包资料管理', desc: '维护官方表情、排序和排行；用户合集审核进入统一审核中心。' },
      ...
      { href: '/admin/salon', title: '沙龙管理', desc: '维护作品分类、场次和图片；审核入口进入统一审核中心。' },
    ],
  },
  {
    title: '导航管理',
