...
export type DuelRealtimeEvent =
  ...
  | { type: 'PLAYER_ANSWERED'; matchId: string; questionIndex: number; userId: string; roundId: string; questionId: string; questionToken: string }
  | { type: 'ANSWER_ACCEPTED'; matchId: string; questionIndex: number; userId: string; correct: boolean; correctOptionKey: string; selectedOptionKey: string; roundId: string; questionId: string; questionToken: string }
