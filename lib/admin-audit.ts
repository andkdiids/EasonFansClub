...
export const adminAuditOperations = {
  ...
  SALON_POST_ADMIN_EDIT: 'SALON_POST_ADMIN_EDIT',
  ...
  ACTIVITY_NOTIFICATION_SEND: 'ACTIVITY_NOTIFICATION_SEND',
...
export const adminAuditOperationLabels: Record<AdminAuditOperation, string> = {
  ...
  POST_RESTORED: '恢复帖子',
  POST_EDITED: '管理员编辑帖子',
  SALON_POST_ADMIN_EDIT: '管理员编辑沙龙作品',
  ...
  ACTIVITY_NOTIFICATION_SEND: '向活动报名用户发送通知',
