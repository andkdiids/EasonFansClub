...
test('个人徽章详情脱离侧栏 stacking context 并使用统一对话框层级', () => {
  ...
  assert.match(profileSummary, /<UserDisplayName name=\{name\} uid=\{user\.uid\} showBadge=\{false\} compact/)
  assert.doesNotMatch(profileSummary, /equippedBadges|equippedBadge/)
