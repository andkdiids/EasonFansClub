...
function snapshot(revision: number, phase: UndercoverPublicMatchSnapshot['phase'] = 'DESCRIBING', round = 1) {
  return {
    ...
    voteState: { stage: null, completedVoteCount: 0, totalVoterCount: 3, abstainCount: 0, isComplete: false },
    viewerVoteStatus: { hasVoted: false, targetPlayerId: null, abstained: false, stage: null },
    alivePlayerIds: [],
    voteResult: null,
    winner: null,
    tieCandidates: [],
